...
### Added
- cmake support.
- version.cpp autogenerated from CMakeLists.txt file.

### Changed
- License changed to BSD 3-clause.
- Class Serial moved into the libserial namespace.
- Enumerated values moved from the Serial class to the libserial namespace.
- Test applications translated into english.
- Throw std::system_error instead of std::ios_base::failure.
...
### Changed
- The structure used in getBaudCode is now private to the function and not to the class.
